...
class Unet_Mip3D(nn.Module):
    def __init__(self):
        ...
        self.pred_soft = nn.Conv3d(in_channels=32, out_channels=1, kernel_size=3, stride=1, padding = 1)
    ...
    def forward(self, x):
        ...
        pred_soft = self.sigmoid(pred_soft)
        # print(torch.unique(pred_soft))
        # feature = {'0':[conv0, deconv_1], '1':[conv1, deconv_2], '2':[conv2, deconv_3],
        #     '3':[conv3, deconv_4], '4':[conv4, deconv_5], '5':[conv5]}
        feature_list = [conv0, conv1, conv2, conv3, conv4, conv5, deconv_5, deconv_4, deconv_3, deconv_2, deconv_1]
        return pred_soft, feature_list
        # return x
...
if __name__ == '__main__':
    ...
    input_tensor = torch.randn(1, 1, 32, 96, 96).cuda()
